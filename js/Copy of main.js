...
//	$.getJSON("/cic/immigration",function(initState){
...
//		nodeHUD.append('test');
	...
	// avatar
	///////////////////////////////////
	alert(initState.name);
	function aAvatar(x,y,z){
		y = y * -2.5;
		x = x * -2.5;

		var myAvatar = new ME3D.Avatar(new THREE.Vector3(x,z,y));
		
		return myAvatar;
	};
	
	var myAvatar = aAvatar(0,0,10);
